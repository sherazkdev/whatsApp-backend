...
userRoute.route("/resend-otp").patch(AsyncHandler(userController.HandleResendOtp)); /** after 60 mint to resend otp again */
userRoute.route("/sign-in").patch(AsyncHandler(userController.HandleLoginUser)); /** sign in user */
...
userRoute.route("/update-user-about").patch(AsyncHandler(authMiddleware.VerifyUserCookies,userController.HandleUpdateUserAbout)); /** update user about */
...
userRoute.route("/sign-out-user").patch(AsyncHandler(authMiddleware.VerifyUserCookies,userController.HandleLogoutUser)); /** logged in user for logout user options */ 
